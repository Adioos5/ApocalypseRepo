...
public class FirstAidKitHandler implements Handler {
    ...
    public FirstAidKitHandler(RootModifier rootModifier, ImageContainer imageContainer, HandlersSwitcher handlersSwitcher,int type){
